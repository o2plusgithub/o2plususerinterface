...
var user_details_model = mongoose.model('user_details_model', user_details_server);
mongoose.connect('mongodb+srv://C6hivgPRCjxKGF9f:yW3c3fc8vpM0ego368z80271RCH@o2plusdatabase.vwl00.mongodb.net/userdetails?retryWrites=true&w=majority', { useUnifiedTopology: true, useNewUrlParser: true, useFindAndModify: false });
...
var subjectlist_model = mongoose.model('subjectlist_model', subjectlist_server);
